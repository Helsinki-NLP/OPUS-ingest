...
$BaseDir = "/cwb/OpenSubtitles";	                # base URL for HTML pages and data files of the CQPDemo
$CacheDir = "/tmp/Subs-Cache";		# local cache directory for persistent query results
...
$Registry = '/home/opus/public_html/cwb/reg/OpenSubtitles';				# set to registry directory if not in standard registry
