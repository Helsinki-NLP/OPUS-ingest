...
$BaseDir = "/cwb/EUconst";	                # base URL for HTML pages and data files of the CQPDemo
$CacheDir = "/tmp/EUconst-Cache";		# local cache directory for persistent query results
...
$Registry = '/home/opus/public_html/cwb/reg/EUconst';				# set to registry directory if not in standard registry
