...
%ParamDefs = (
	      ...
	      "context" => {			# KWIC context
			    type => "code",
#			    values => ["5 words", "1 s", "2 s", "1 p", "1 time", "2 time"], # parameter values
#			    desc => ["5 words", "sentence", "2 sentences", "paragraph", "1 timeslot" ,  "2 timeslots"], # value descriptions shown in HTML form
			    values => ["5 words", "1 s", "2 s", "4 s", "1 time", "2 time"], # parameter values
			    desc => ["5 words", "sentence", "2 sentences", "4 sentences", "1 timeslot" ,  "2 timeslots"], # value descriptions shown in HTML form
