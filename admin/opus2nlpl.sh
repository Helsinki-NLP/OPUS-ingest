...
SUBDIR='admin annotated data html img incoming public_html tools trac udwordalign wordalign wordalign-multi'

cd $OPUSDIR
echo -n $SUBDIR | parallel -d ' ' rsync --delete -ahv {} /proj/nlpl/corpora/OPUS/
cd $OPUSDIR/corpus
